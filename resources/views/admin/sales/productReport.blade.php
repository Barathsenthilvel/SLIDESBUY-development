        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Product Report</h5>
                    <!--end::Page Title-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="" class="text-muted">Product Report</a>
                        </li>
                    </ul>
                </div>
                <!--end::Page Heading-->
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">List of Product Report</h3>
                    </div>
...
@push('script')                  
     ...
     function loadtable(){
        var table = $('#geniustable').DataTable({
               ...
               scrollX: true,
               ajax: {
                   url : "{{ route('admin-report-product-get') }}",
                   type : 'POST',
               ...
               columns: [
                        ...
                        { data: 'mrp', name: 'mrp'},
                        { data: 'manufacturerPrice', name: 'manufacturerPrice'},
                        { data: 'seller_price', name: 'seller_price'},
                        { data: 'Discount_price', name: 'Discount_price'},
                        { data: 'special_discount_price', name: 'special_discount_price'},
