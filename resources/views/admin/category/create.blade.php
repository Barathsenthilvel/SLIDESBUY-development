                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="{{route('admin-category-store')}}" enctype="multipart/form-data" id="formCreate" onsubmit="if(typeof CKEditor1 != 'undefined'){ CKEditor1.updateSourceElement(); }">
                                                {{ csrf_field() }}
