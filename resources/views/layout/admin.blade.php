                    ...
                    <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                        ...
                        <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                            ...
                            <div class="text-dark order-2 order-md-1">
                                <span class="text-muted font-weight-bold mr-2">{{ $StoreConfig->Store_Meta_Title }} © {{ date('Y') }}</span>
            ...
            <div class="offcanvas-content pr-5 mr-n5">
                ...
                <div class="d-flex align-items-center mt-5">
                    <div class="symbol symbol-100 mr-5">
                        <div class="symbol-label" style="background-image:url({{URL::asset('/assets/media/users/'.auth()->user()->photo)}})"></div>
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="text-muted mt-1">{{ (auth()->user()->role_name)?auth()->user()->role_name->role_name:''  }}</div>
                        <div class="navi mt-2">
                            <a href="#" class="navi-item">
