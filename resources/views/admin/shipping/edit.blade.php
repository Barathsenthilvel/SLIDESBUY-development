                                                ...
                                                <div class="card-body">
                                                   ...
                                                   <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-8">
                                                            <select class="form-control" type="text" value="" id="pincode_id" name="pincode_id[]" multiple>
                                                                @foreach ( $Pincode as $pincode)
                                                                <option value="{{$pincode->id}}" {{ in_array($pincode->id,$data->pincode_id) ? 'selected' : '' }}>{{$pincode->pincode}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
