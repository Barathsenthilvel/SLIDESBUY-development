									...
									<div class="col-xl-3">
										...
										<div class="card card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url(assets/media/svg/shapes/abstract-1.svg)">
											...
											<div class="card-body">
												...
												<span class="font-weight-bold text-muted font-size-sm"><a style="color: #3F4254 !important;" href="{{route('admin-customer')}}">Customers</a></span>
            ...
            $link=route('admin-product-group');
													...
													<table class="table table-borderless table-vertical-center">
														<thead>
															<tr>
																...
																<th class="text-center" style="min-width: 130px">Prduct Name</th>
																<th class=" text-center" style="min-width: 50px">Base Price</th>
																<th class=" text-center" style="min-width: 100px">SKU</th>
																<th class=" text-center" style="min-width: 210px">Date</th>
															</tr>
														</thead>
														<tbody>
															...
															<tr>
																...
																<td class="text-center">
																	<span class="text-muted font-weight-bold"><a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">{{ $NewProduct->product_base_price}}</a></span>
																</td>
																<td class="text-center">
																	<span class="text-muted font-weight-bold"><a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">{{$StoreConfig->productIdprefix}}{{ $NewProduct->product_sku}}</a></span>
																</td>
																<td class="text-left">
																	<span class="text-muted font-weight-bold">
																	    <a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">Create At : {{ date('Y-m-d',strtotime($NewProduct->created_at)) }}</br>
																	    Updated At : {{ date('Y-m-d',strtotime($NewProduct->updated_at)) }}</a>
																	</span>
																</td>
                                                            </tr>
                                                            @endforeach 
													...
													<table class="table table-borderless table-vertical-center">
														...
														<tbody>
															...
															<tr>
																...
																<td class="text-center">
																	<span class="text-muted font-weight-bold"><a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">{{ $NewCustomer->email }}</a></span>
																</td>
																<td class="text-center">
																	<span class="text-muted font-weight-bold"><a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">{{ $NewCustomer->Phone }}</a></span>
																</td>
                                                                <td class="text-center">
																	<span class="text-muted font-weight-bold">
																	    <a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">
																	        {{ ($NewCustomer->status == '1')?'Active':'Deactive' }}
																	    </a>
																    </span>
																</td>
																<td class="text-left">
																	<span class="text-muted font-weight-bold">
																	    <a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">Create At : {{ date('Y-m-d',strtotime($NewCustomer->created_at)) }}
																	</span>
																</td>
                                                            </tr>
                                                            @endforeach 
									...
									<div class="col-xl-6">
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label font-weight-bolder text-dark">Cancelled Order</span>
												</h3>
													...
													<table class="table table-borderless table-vertical-center">
														...
														<tbody>
															...
															<tr>
																...
																<td class="text-center">
																    @php
																        $cart = unserialize(bzdecompress(utf8_decode($NewOrder->card)));
																        $item = $cart->singleorder[0];
																    @endphp
																	<span class="text-muted font-weight-bold">{{ $item->product_title}}</span>
																</td>
																<td class="text-center">
...
var CustomKTWidgets = function () {
    ...
    var Custom_demo3 = function () {
		...
		var options = {
			...
			{
				name: "Total ({{ (Auth::user()->is_vendor)?' + delivery charges':'delivery charges + Tax' }})",
				data: total
			}],
			chart: {
				type: 'bar',
