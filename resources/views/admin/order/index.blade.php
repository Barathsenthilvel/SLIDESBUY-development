    ...
    var table = $('#kt_datatable1').DataTable({
        ...
        columnDefs: [{
								...
								<a href="javascript:;" class="btn btn-sm btn-clean btn-icon" data-toggle="dropdown">\
							  	...
							  	<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">\
									<ul class="nav nav-hoverable flex-column">\
							    		...
							    		<li class="nav-item"><a class="nav-link label_download" href="'+full.URL.label+'"><i class="nav-icon la la-print" href="'+full.URL.label+'"></i><span href="'+full.URL.label+'" class="nav-text">Lable</span></a></li>\
									</ul>\
							  	</div>\
							</div>\
						';
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    if(full.is_vendor){
                        return `Total Amount : ${full.vendororderdata.total}</br>
                            Items : ${full.vendororderdata.count}`;
                    }else{
                     return `Total Amount : ${full.grandTotal}</br>
                        Items : ${full.total_items}`;   
                    }
                },
            },
            {
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    if(status[data].title == "refund" ){ return '<span class="font-weight-bold text-danger">'+status[data].title+'</span>';  }
                    var option = "";
                    for(var K in status){
...
$('body').on('click','.label_download',function(e){
    e.preventDefault();
    $('#loaderFrame').attr('src', e.target.getAttribute('href'));
})
